...
class load_savemodel(object):

    def create_parser(self,name):
        p = argparse.ArgumentParser(description = "parameter for loading models")
        ...
        p.add_argument('-l', metavar = 'load-model', type = str, help = "load-model")
    ...
    ###########################################################################################################################################################
        ...
        stack_model = joblib.load(opts.l)
